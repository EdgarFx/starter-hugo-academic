...
$$X_{c0} = \begin{bmatrix} x_0 + v_x s_0 \\ y_0 + v_y s_0 \\ z_0 + v_z s_0 \end{bmatrix}$$

Combining the equations, we have:

$$\begin{bmatrix} R^{cl}_{11} & R^{cl}_{21} & v_x \\ R^{cl}_{12} & R^{cl}_{22} & v_y \\ R^{cl}_{13} & R^{cl}_{23} & v_z \end{bmatrix} \begin{bmatrix} t^{cl}_1 \\ t^{cl}_2 \\ s_0 \end{bmatrix} = \begin{bmatrix} -x_0 - R^{cl}_{31} t^{cl}_3 \\ -y_0 - R^{cl}_{32} t^{cl}_3 \\ -z_0 - R^{cl}_{33} t^{cl}_3 \end{bmatrix}$$
