...
My research interests lie in achieving robust robotic systems that enable long-term autonomous mobility and comprehensive environmental perception and understanding under challenging conditions, such as confined spaces, severe illumination changes, dynamic objects, etc. My current research focuses on **Multi-sensor SLAM** and **Learning-based SLAM**. In addition to localization, mapping, and perception, I am now also very interested in navigation and control for autonomous systems.
